// REMOVED: duplicate file - cleared by automated cleanup
// File intentionally emptied to avoid duplicate scripts. See `index.fixed.html` and `minimal_bw.css` for active code.
/* no-op */
...
// main.js — preloader, mobile nav toggle, smooth scroll, reveal on scroll
(function () {
  'use strict';
